...
class Q_PAT(Dataset):
    ...
    def __getitem__(self, item):
        ...
        tensor_p0 = self.transform(Image.fromarray(np.uint8(numpy_p0)).convert('RGB'))
        tensor_p1 = self.transform(Image.fromarray(np.uint8(numpy_p1)).convert('RGB'))
